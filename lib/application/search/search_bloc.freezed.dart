...
/// @nodoc
mixin _$SearchState {
  List<SearchResults> get searchResult => throw _privateConstructorUsedError;
...
class _$_SearchState implements _SearchState {
  const _$_SearchState(
      {required final List<SearchResults> searchResult,
  ...
  final List<SearchResults> _searchResult;
  @override
  List<SearchResults> get searchResult {
